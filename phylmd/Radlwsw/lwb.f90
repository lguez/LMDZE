...
! PTAVE  : (KDLON,LLM)       ; TEMPERATURE
! PTL    : (KDLON,0:LLM)     ; HALF LEVEL TEMPERATURE
!     ==== OUTPUTS ===
! PB     : (KDLON,Ninter,LLM+1); SPECTRAL HALF LEVEL PLANCK FUNCTION
! PBINT  : (KDLON,LLM+1)     ; HALF LEVEL PLANCK FUNCTION
...
! PDBSL  : (KDLON,Ninter,LLM*2); SUB-LAYER PLANCK FUNCTION GRADIENT
! PGA    : (KDLON,8,2,LLM); dB/dT-weighted LAYER PADE APPROXIMANTS
! PGB    : (KDLON,8,2,LLM); dB/dT-weighted LAYER PADE APPROXIMANTS
...
!
      DOUBLE PRECISION PB(KDLON,Ninter,LLM+1) ! SPECTRAL HALF LEVEL PLANCK FUNCTION
      ...
      DOUBLE PRECISION PGA(KDLON,8,2,LLM) ! dB/dT-weighted LAYER PADE APPROXIMANTS
      DOUBLE PRECISION PGB(KDLON,8,2,LLM) ! dB/dT-weighted LAYER PADE APPROXIMANTS
...
!*  LOCAL VARIABLES:
      ...
      DOUBLE PRECISION ZBLAY(KDLON,LLM),ZBLEV(KDLON,LLM+1)
