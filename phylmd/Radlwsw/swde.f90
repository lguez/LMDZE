...
contains
  ...
  SUBROUTINE swde(pgg, pref, prmuz, pto1, pw, pre1, pre2, ptr1, ptr2)
    ...
    DOUBLE PRECISION pgg(klon) ! ASSYMETRY FACTOR
    DOUBLE PRECISION pref(klon) ! REFLECTIVITY OF THE UNDERLYING LAYER
    DOUBLE PRECISION prmuz(klon) ! COSINE OF SOLAR ZENITH ANGLE
    DOUBLE PRECISION pto1(klon) ! OPTICAL THICKNESS
    DOUBLE PRECISION pw(klon) ! SINGLE SCATTERING ALBEDO
    DOUBLE PRECISION pre1(klon) ! LAYER REFLECTIVITY (NO UNDERLYING-LAYER REFLECTION)
    DOUBLE PRECISION pre2(klon) ! LAYER REFLECTIVITY
    DOUBLE PRECISION ptr1(klon) ! LAYER TRANSMISSIVITY (NO UNDERLYING-LAYER REFLECTION)
    DOUBLE PRECISION ptr2(klon) ! LAYER TRANSMISSIVITY
