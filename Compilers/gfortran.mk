...
netcdf_inc_dir = /user/guez_local/include /user/guez_local/include/Gfortran
...
jumble_dir = /user/guez_local/lib/Jumble

# Include flags:
inc_flags = $(addprefix -I, ${libf_dir} ${libf_dir}/phylmd ${netcdf_inc_dir} ${numer_rec_dir} ${netcdf95_dir} ${nr_util_dir} ${jumble_dir})
...
LDLIBS = $(addprefix -L, ${netcdf_lib_dir} ${numer_rec_dir} ${netcdf95_dir} ${nr_util_dir} ${jumble_dir}) -ljumble -lnetcdf95 -lnetcdff -lnetcdf -lhdf5_hl -lhdf5 -lnumer_rec -lnr_util
