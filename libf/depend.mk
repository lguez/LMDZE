...
advect.o : ener.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
advn.o : iniprint.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
advtrac.o : comdissip.o advtrac_m.o ener.o temps.o comgeom.o logic.o conf_gcm.o comvert.o comconst.o paramet_m.o dimens_m.o 
advtrac_m.o : dimens_m.o 
...
caldyn0.o : pression.o comgeom.o comvert.o comconst.o paramet_m.o dimens_m.o 
calfis.o : physiq.o grid_change.o advtrac_m.o comgeom.o comvert.o comconst.o dimphy.o dimens_m.o 
calltherm.o : ctherm.o dimphy.o dimens_m.o 
clcdrag.o : YOETHF.o YOMCST.o indicesol.o 
clift.o : YOMCST.o 
clmain.o : gath_cpl.o conf_phys.o FCTTRE.o YOETHF.o YOMCST.o iniprint.o temps.o dimsoil.o dimphy.o indicesol.o dimens_m.o interface_surf.o 
...
cvltr.o : YOECUMF.h YOMCST.o dimphy.o dimens_m.o 
...
dynetat0.o : netcdf95.o advtrac_m.o ener.o temps.o serre.o comgeom.o logic.o comvert.o comconst.o dimens_m.o 
dynredem0.o : advtrac_m.o ener.o temps.o serre.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
dynredem1.o : advtrac_m.o abort_gcm.o temps.o comgeom.o paramet_m.o dimens_m.o 
ener.o : dimens_m.o 
enercin.o : comgeom.o paramet_m.o dimens_m.o 
etat0.o : pressure_m.o netcdf95.o advtrac_m.o regr_coefoz.o exner_hyb.o q_sat.o grid_change.o grid_atob.o clesphys.o temps.o dimsoil.o serre.o comgeom.o conf_gcm.o comvert.o comdissnew.o comconst.o paramet_m.o dimens_m.o startdyn.o start_init_phys_m.o start_init_orog_m.o dimphy.o indicesol.o 
etat0_lim.o : limit.o etat0.o conf_gcm.o comconst.o 
exner_hyb.o : comgeom.o comvert.o comconst.o dimens_m.o 
filtreg.o : coefils.h parafilt.h paramet_m.o dimens_m.o 
...
fxy.o : fxy_new.h serre.o comconst.o paramet_m.o dimens_m.o 
fxyhyper.o : paramet_m.o dimens_m.o 
fxysinus.o : fxy_sin.h comconst.o paramet_m.o dimens_m.o 
fyhyp.o : paramet_m.o dimens_m.o 
gcm.o : leapfrog.o advtrac_m.o grid_change.o dynetat0.o initdynav.o inithist.o abort_gcm.o tracstoke.o com_io_dyn.o temps.o comgeom.o logic.o conf_gcm.o comdissnew.o comconst.o paramet_m.o dimphy.o dimens_m.o 
...
inifilr.o : coefils.h parafilt.h serre.o comgeom.o logic.o paramet_m.o dimens_m.o 
...
initdynav.o : advtrac_m.o ener.o temps.o serre.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
initfluxsto.o : ener.o temps.o serre.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
inithist.o : advtrac_m.o ener.o temps.o serre.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
...
integrd.o : pression.o advtrac_m.o temps.o serre.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
inter_barxy.o : comconst.o comgeom.o dimens_m.o 
interface_surf.o : inc_cpl.h param_cou.h FCTTRE.o YOETHF.o clesphys.o iniprint.o temps.o albsno_m.o YOMCST.o indicesol.o gath_cpl.o abort_gcm.o 
...
leapfrog.o : pression.o guide.o exner_hyb.o calfis.o ener.o abort_gcm.o com_io_dyn.o iniprint.o temps.o serre.o comgeom.o logic.o conf_gcm.o comvert.o comconst.o paramet_m.o dimens_m.o 
limit.o : netcdf95.o grid_change.o inter_barxy.o conf_dat2d.o start_init_orog_m.o etat0.o comgeom.o conf_gcm.o dimphy.o indicesol.o comconst.o dimens_m.o 
...
nflxtr.o : YOECUMF.h YOMCST.o dimphy.o dimens_m.o 
...
o3_chem_m.o : orbite.o read_coefoz_m.o dimens_m.o dimphy.o 
o3_mob_ph_m.o : grid_change.o netcdf95.o dimphy.o dimens_m.o 
orbite.o : comconst.o phyetat0.o dimphy.o YOMCST.o 
orografi.o : YOEGWD.h YOMCST.o dimphy.o dimens_m.o 
...
phyetat0.o : clesphys.o temps.o dimsoil.o indicesol.o dimens_m.o dimphy.o 
phyredem.o : clesphys.o temps.o dimsoil.o conf_gcm.o dimphy.o indicesol.o dimens_m.o 
physiq.o : FCTTRE.o conf_phys.o hgardfou.o phyetat0.o orbite.o ini_hist.o YOETHF.o radopt.o radepsi.o oasis_m.o phytrac.o ctherm.o comgeomphy.o YOMCST.o abort_gcm.o iniprint.o clesphys.o temps.o dimsoil.o conf_gcm.o dimphy.o indicesol.o dimens_m.o 
phystokenc.o : tracstoke.o conf_gcm.o dimphy.o indicesol.o dimens_m.o 
phytrac.o : grid_change.o comgeomphy.o advtrac_m.o temps.o o3_chem_m.o phyetat0.o read_coefoz_m.o ctherm.o YOMCST.o abort_gcm.o clesphys.o dimphy.o indicesol.o dimens_m.o 
plevel.o : dimphy.o dimens_m.o 
prather.o : comgeom.o comvert.o comconst.o paramet_m.o dimens_m.o 
pression.o : dimens_m.o 
pressure_m.o : dimens_m.o 
printflag.o : clesphys.o 
psextbar.o : comgeom.o paramet_m.o dimens_m.o 
qminimum.o : comvert.o paramet_m.o dimens_m.o 
raddim.o : dimens_m.o 
radlwsw.o : raddimlw.h radopt.o radepsi.o dimens_m.o YOETHF.o raddim.o YOMCST.o clesphys.o dimphy.o 
read_coefoz_m.o : phyetat0.o o3_mob_ph_m.o netcdf95.o dimphy.o dimens_m.o 
...
regr_coefoz.o : netcdf95.o regr1_lint_m.o regr1_step_av_m.o pressure_m.o comconst.o comgeom.o dimens_m.o 
...
test_disvert.o : in_out.o comconst.o comvert.o dimens_m.o 
...
writedynav.o : advtrac_m.o ener.o temps.o serre.o comgeom.o logic.o comvert.o comconst.o paramet_m.o dimens_m.o 
