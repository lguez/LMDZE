...
clift.o : YOMCST.o 
clmain.o : hbtm.o gath_cpl.o conf_phys.o YOMCST.o iniprint.o dynetat0.o temps.o dimsoil.o dimphy.o indicesol.o dimens_m.o calendar.o histwrite.o histcom.o 
...
gcm.o : tracstoke.o temps.o suphec.o paramet_m.o logic.o leapfrog.o histcom.o calendar.o inithist.o initdynav.o inigeom.o inidissip.o iniadvtrac.o grid_change.o dynredem0.o dynetat0.o dimphy.o dimens_m.o conf_gcm.o comgeomphy.o comgeom.o comconst.o com_io_dyn.o clesphys2.o 
...
guide.o : tau2alpha.o inigrads.o exner_hyb.o q_sat.o serre.o comgeom.o conf_gcm.o comvert.o comconst.o paramet_m.o dimens_m.o 
...
integrd.o : filtreg.o comgeom.o comvert.o paramet_m.o dimens_m.o 
...
leapfrog.o : temps.o pressure_var.o paramet_m.o logic.o integrd.o inidissip.o guide.o filtreg.o exner_hyb.o dynredem1.o dynetat0.o dimens_m.o conf_gcm.o comvert.o comgeom.o comconst.o com_io_dyn.o calfis.o addfi.o 
...
physiq.o : gr_phy_write_3d.o FCTTRE.o YOMCST.o yoethf.o temps.o radopt.o radepsi.o qcheck.o phytrac.o phystokenc.o phyredem.o phyetat0.o ozonecm.o orbite.o oasis_m.o iniprint.o ini_histins.o ini_histday.o ini_histhf.o indicesol.o histwrite.o histcom.o hgardfou.o dimsoil.o dimphy.o dimens_m.o ctherm.o conf_phys.o conf_gcm.o comgeomphy.o clesphys2.o clesphys.o calendar.o abort_gcm.o 
phystokenc.o : tracstoke.o dimphy.o indicesol.o dimens_m.o histcom.o histwrite.o 
phytrac.o : gr_phy_write_3d.o grid_change.o comgeomphy.o iniadvtrac.o temps.o histwrite.o histcom.o press_coefoz.o minmaxqfi.o radiornpb.o ini_histrac.o o3_chem.o phyetat0.o regr_pr_comb_coefoz.o ctherm.o YOMCST.o abort_gcm.o clesphys2.o clesphys.o dimphy.o indicesol.o dimens_m.o 
...
startdyn.o : conf_dat3d.o start_init_phys_m.o start_init_orog_m.o gr_int_dyn_m.o dimens_m.o comconst.o inter_barxy.o conf_dat2d.o comgeom.o flinget.o flincom.o 
...
tau2alpha.o : serre.o comgeom.o comconst.o paramet_m.o dimens_m.o 
