...
ce0l.o : unit_nml_m.o read_serre.o limit.o grilles_gcm_netcdf_sub.o etat0.o dimens_m.o conf_gcm.o 
clcdrag.o : yoethf.o suphec.o indicesol.o 
cleanstr.o : mathelp.o strlowercase.o 
clesphys2.o : conf_gcm.o unit_nml_m.o 
clmain.o : yamada4.o vdif_kcay.o ustarhb.o suphec.o stdlevvar.o indicesol.o hbtm.o dimsoil.o dimphy.o conf_phys.o conf_gcm.o coefkzmin.o coefkz.o clvent.o clqh.o 
...
gcm.o : createnewfield.o yoethf.o unit_nml_m.o tracstoke.o suphec.o leapfrog.o ioconf_calendar.o init_dynzon.o inithist.o initdynav.o inifilr.o inidissip.o iniadvtrac.o histclo.o grid_change.o dynredem0.o dynetat0.o disvert.o dimens_m.o conf_guide.o conf_gcm.o comgeomphy.o comgeom.o comconst.o 
geopot.o : dimens_m.o 
...
ini_histins.o : ymds2ju.o phyetat0.o iniadvtrac.o indicesol.o histvert.o histend.o histdef.o histbeg_totreg.o gr_fi_ecrit.o dynetat0.o disvert.o dimphy.o dimens_m.o clesphys2.o clesphys.o 
...
initphysto.o : ymds2ju.o comgeom.o conf_gcm.o dimphy.o indicesol.o comconst.o paramet_m.o dimens_m.o histvert.o histsync.o histend.o histdef.o histbeg_totreg.o gr_fi_ecrit.o dynetat0.o 
...
interfoce_lim.o : indicesol.o dimphy.o 
interfsur_lim.o : dimphy.o 
interfsurf_hq.o : suphec.o soil.o interfsur_lim.o interfoce_lim.o interface_surf.o indicesol.o fonte_neige.o dimphy.o clesphys2.o calcul_fluxs.o calbeta.o albsno.o alboc.o alboc_cd.o abort_gcm.o 
...
phyetat0.o : indicesol.o dimsoil.o dimphy.o 
phyredem.o : phyredem0.o indicesol.o dimphy.o 
phyredem0.o : phyetat0.o indicesol.o dimsoil.o dimphy.o conf_gcm.o 
physiq.o : histwrite.o histsync.o gr_fi_ecrit.o zenang.o yoethf.o ymds2ju.o unit_nml_m.o transp_lay.o transp.o suphec.o YOEGWD.o readsulfate_preind.o readsulfate.o radlwsw.o qcheck.o phytrac.o phystokenc.o phyredem0.o phyredem.o phyetat0.o ozonecm.o orbite.o nuage.o newmicro.o ini_histins.o indicesol.o hgardfou.o fisrtilp.o FCTTRE.o dynetat0.o drag_noro.o dimsoil.o dimphy.o dimens_m.o diagphy.o diagetpq.o diagcld2.o ctherm.o conflx.o conf_phys.o conf_gcm.o concvl.o comgeomphy.o comconst.o clouds_gno.o clmain.o clesphys2.o clesphys.o calltherm.o ajsec.o aeropt.o abort_gcm.o aaam_bud.o 
phystokenc.o : tracstoke.o dimphy.o initphysto.o indicesol.o dimens_m.o histsync.o histwrite.o gr_fi_ecrit.o 
phytrac.o : gr_phy_write_3d.o iniadvtrac.o histwrite.o suphec.o regr_pr_comb_coefoz.o radiornpb.o press_coefoz.o phyredem0.o phyetat0.o o3_chem.o nflxtr.o minmaxqfi.o initrrnpb.o indicesol.o dimphy.o dimens_m.o cvltr.o ctherm.o cltracrn.o cltrac.o clesphys2.o clesphys.o abort_gcm.o 
